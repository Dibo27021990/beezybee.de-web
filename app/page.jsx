    ...
    <>
      ...
      <main className="min-h-screen bg-white px-4 py-16">
        ...
        <section id="screenshots" className="py-8 bg-white">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <img src="/images/appscreen1.png" alt={t('screenshots.alt1')} className="w-[250px] rounded-xl" />
            <img src="/images/appscreen2.png" alt={t('screenshots.alt2')} className="w-[250px] rou
