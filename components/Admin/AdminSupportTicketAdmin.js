// components/Admin/SupportTicketAdmin.js (Admin-View: Supportanfragen)
...
export default function SupportTicketAdmin() {
  ...
  return (
    <View style={styles.bg}>
      <Text style={styles.title}>Support-Anfragen</Text>
      <FlatList
        data={tickets}
...
const styles = StyleSheet.create({
  ...
  row: { borderBottomWidth: 1, borderBottomColor: '#f4eeb1', paddingVertical: 10 },
  name: { fontFamily: beezyFont.bold, color: colors.primary, fontSize: 14 },
  text: { fontFamily: beezyFont.regular, color: colors.text, fontSize: 14, marginVertical: 5 },
